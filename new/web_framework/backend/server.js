...
app.get('/api/player/:playerId/equipped', async (req, res) => {
    try {
        const playerId = req.params.playerId;
...
// Equip an item
app.post('/api/player/:playerId/equip', async (req, res) => {
    try {
        const playerId = req.params.playerId;
...
// Unequip an item
app.post('/api/player/:playerId/unequip', async (req, res) => {
    try {
        const playerId = req.params.playerId;
        const { slot } = req.body;
...
app.get('/api/player/:playerId/weapon/:weaponId/mods', async (req, res) => {
    try {
        const playerId = req.params.playerId;
...
app.get('/api/player/:playerId/mods', async (req, res) => {
    try {
        const playerId = req.params.playerId;
...
app.post('/api/player/:playerId/weapon/:weaponId/equip-mod', async (req, res) => {
    try {
        const playerId = req.params.playerId;
        const weaponId = req.params.weaponId;
...
app.post('/api/player/:playerId/weapon/:weaponId/unequip-mod', async (req, res) => {
    try {
        const playerId = req.params.playerId;
        const weaponId = req.params.weaponId;
...
app.post('/api/player/:playerId/weapon/:weaponId/save-modified', async (req, res) => {
    try {
        const playerId = req.params.playerId;
        const weaponId = req.params.weaponId;
...
app.delete('/api/admin/cleanup-modified-weapons', async (req, res) => {
    try {
...
app.post('/api/player/:playerId/complete-mission', async (req, res) => {
    try {
        const playerId = req.params.playerId;
...
// Start server
app.listen(port, () => {
    console.log(`Courier Backend API running at http://localhost:${port}`);
    console.log(`Health check: http://localhost:${port}/api/health`);
    console.log(`Player 1 inventory: http://localhost:${port}/api/player/1/inventory`);
    console.log(`Player 1 equipped: http://localhost:${port}/api/player/1/equipped`);
});
